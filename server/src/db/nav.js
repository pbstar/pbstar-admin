const db = {
  list: [
    ...
    { id: 2, name: "示例应用", parentId: null, url: null },
    {
      ...
      name: "列表",
      parentId: 2,
      url: "/admin/app-example?app-example=%2Flist",
    },
    { id: 4, name: "系统管理", parentId: null },
    {
      ...
      name: "菜单管理",
      parentId: 4,
      url: "/admin/app-system?app-system=%2Flist",
    },
    {
      id: 6,
      name: "代码生成器",
      parentId: 4,
      url: "/admin/app-system?app-system=%2Fgenerator",
    },
    {
      id: 7,
      name: "Echarts示例",
      parentId: 2,
      url: "/admin/app-example?app-example=%2Fecharts",
    },
  ],
  lastId: 2,
};
