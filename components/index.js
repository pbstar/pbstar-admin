...
export { default as PTable } from "./base/p-table/index.vue";
export { default as PTitle } from "./base/p-title/index.vue";
...
// 页面组件
export { default as Page403 } from "./page/403.vue";
export { default as Page404 } from "./page/404.vue";
